...
$$ \exists B, \forall y. y \in B \iff (\exists x. x \in A \land P(x, y) \land \forall z. \psi(x, z) \implies z = y) $$
...
\begin{table}[h]
  \begin{tabular}{l|l}
    ...
    \lstinline|t.replace(P)| & $e \in c \iff (\exists x. x \in t \land P(x, e) \land \forall z. P(x, z) \implies z = e)$ \\
