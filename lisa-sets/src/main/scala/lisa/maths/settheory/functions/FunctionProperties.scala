...
// import lisa.automation.kernel.CommonTactics.{Definition, ExistenceAndUniqueness}
...
//  */
object FunctionPoperties {
//   import lisa.maths.settheory.SetTheory.{*, given}
//   // import lisa.maths.settheory.functions.Functionals.*

// //import lisa.maths.Quantifiers.{equalityTransitivity, uniqueExistentialEquivalenceDistribution, existentialEquivalenceDistribution}
// //import lisa.maths.settheory.functions.Functionals.*
...
//   /**
//    * Theorem --- the domain of a constant function is the set
//    * it is defined on.
//    */
...
//   /**
//    * Theorem --- a constant function is a functional.
//    */
...
//         have(∃!(y, in(pair(a, y), constantFunction(x, t)))) by Sorry // ExistenceAndUniqueness(in(pair(a, y), constantFunction(x, t)))(existence, uniqueness)
//       }
...
//   /**
//    * Theorem --- a constant function is in the function space `x → {t}`.
//    */
